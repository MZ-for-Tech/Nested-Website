      ...
      <div className={styles.content}>
        ...
        <div className={styles.gridSection}>
          ...
          <div className={styles.grid}>
            {services.map(({ id, Icon, title, description, hoverClass }) => (
              <div key={id} className={`${styles.card} ${hoverClass}`}>
